...
- **Home Commands:** " Deleted "
- **Tpa Commands:** Có chân tự mà đi ( Deleted )
- **Help Command:** ( Updated )
- **Elytra Speed Limiter:** Controls the speed of players using Elytras ( Updated ).
...
- **Feature Suggestions:** We welcome your ideas for new features! Join our [Discord server](https://discord.gg/ayVMkDuC2n) to share your thoughts.
...
1. Download the latest version of the 9C9LCore plugin.
